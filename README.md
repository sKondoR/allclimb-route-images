...
- 📥 **Автоматическая загрузка данных** — регионы, секторы, трассы и их описание парсятся с Allclimb, картинки берутся с помощью [Playwright](https://playwright.dev) и сохраняются в PostgreSQL.
